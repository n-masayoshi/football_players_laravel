    ...
    <div class="col-md-8 col-lg-9">
        <form method="POST" action="{{ route('players.store', ['country_id' => $country_id]) }}" class="max-w-sm mx-auto">
            ...
            <div class="mb-5">
                ...
                <input type="number" id="country_id" name="country_id" value="<?= $country_id ?>" class="mb-2 shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-gray-50 focus:border-gray-300 block w-full p-2.5" placeholder="国" readonly />
            </div>
            <div class="mb-5">
