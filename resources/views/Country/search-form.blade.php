...
<div id="accordion-collapse" data-accordion="collapse">
    ...
    <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
        <div class="text-gray-900 p-5 border border-sky-200 dark:border-sky-700 dark:bg-sky-900">
            ...
            <form class="space-y-4" method="POST" action="{{ route('country.search') }}">
                @csrf
                <div class="flex">
                    <div class="w-1/4 px-3 ">
                        <x-input-label for="country_name" :value="'国名'" />
                        <select name="country_id" id="country_id" class="form-select border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
