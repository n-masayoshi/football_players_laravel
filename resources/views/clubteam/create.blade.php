...
<div class="row max-w-screen-lg mx-auto">
    <div class="col-md-8 col-lg-9">
        <form method="POST" action="{{ route('clubteam.players.store', ['club_team_id' => $club_team_id]) }}" class="max-w-sm mx-auto">
            @csrf
            <div class="mb-5">
                <label for="club_team_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">クラブチーム ID</label>
                <input type="number" id="club_team_id" name="club_team_id" value="<?= $club_team_id ?>" class="mb-2 shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-gray-50 focus:border-gray-300 block w-full p-2.5" placeholder="クラブチーム" readonly />
            </div>
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="country_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">国</label>
                <select name="country_id" id="country_id" class="mb-6 shadow-sm bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
